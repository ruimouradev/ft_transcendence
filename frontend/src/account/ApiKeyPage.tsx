              ...
              <Stack spacing={3}>
                ...
                {status?.has_api_key ? (
                  <>
                    ...
                    {status.client_id && (<CopyField label="Client ID" value={status.client_id} copied={copied === "existing_client_id"} onCopy={() => copyToClipboard(status.client_id!, "existing_client_id")} />)}
