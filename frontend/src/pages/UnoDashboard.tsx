                ...
                <Grid size={{ xs: 3 }}>
                  <Tooltip title="Click to filter winning matches" arrow>
                    ...
                    >
                      ...
                      <Typography variant="h6" sx={{ mt: 0.5, fontWeight: 'bold', color: 'success.main' }}>287</Typography>
                    </Paper>
                  </Tooltip>
                </Grid>
                ...
                <Grid size={{ xs: 3 }}>
                  <Tooltip title="Click to filter losing matches" arrow>
                    ...
                    >
                      ...
                      <Typography variant="h6" sx={{ mt: 0.5, fontWeight: 'bold', color: 'primary.main' }}>125</Typography>
                    </Paper>
                  </Tooltip>
                </Grid>
                ...
                <Grid size={{ xs: 3 }}>
                  <Tooltip title="Click to view pie chart summary" arrow>
                    ...
                    >
                      ...
                      <Typography variant="h6" sx={{ mt: 0.5, fontWeight: 'bold', color: 'secondary.main' }}>69.66%</Typography>
                    </Paper>
                  </Tooltip>
                </Grid>
              </Grid>
                    ...
                    <Box sx={{ position: 'relative', display: 'inline-flex', justifyContent: 'center', alignItems: 'center', my: 2 }}>
                      <svg width="180" height="180" viewBox="0 0 42 42">
                        ...
                        <circle
                          ...
                          stroke="#4caf50"
                          strokeWidth="5"
                          strokeDasharray="69.66 30.34"
                          strokeDashoffset="25"
                        />
                      </svg>
                      <Box sx={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        <Typography variant="h5" sx={{ fontWeight: 'bold', color: '#4caf50' }}>69.7%</Typography>
                        <Typography variant="caption" color="text.secondary">Win Rate</Typography>
                      </Box>
                    </Box>
