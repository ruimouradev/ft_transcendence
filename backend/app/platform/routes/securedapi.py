...
@router.get("/onlineplayers", response_model=list[UserOnLineStatus], summary="An secured API endpoint,get online players", description=''' ## Retrieve a list of online players. Requires a valid API key and client ID.''')
